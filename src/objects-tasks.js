...
function makeWord(lettersObject) {
  ...
  const str = Object.entries(newObj)
    .sort((a, b) => a[0] - b[0])
...
const cssSelectorBuilder = {
  selector: '',
  element(value) {
    if (!this.selector) this.selector += value;
    return this;
  },

  id(value) {
    if (this.idCalled) throw new Error('already defined');
    this.selector += `#${value}`;
    return this;
  },
